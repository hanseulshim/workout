...
export function ActiveWorkoutRestTimer({
  ...
  return (
    <div className={cn(
      "flex items-center justify-between gap-3 rounded-2xl border bg-background/95 px-4 py-3 shadow-lg backdrop-blur-sm transition-colors duration-300 w-full",
